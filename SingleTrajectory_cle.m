function [Y, X, time, run_time] = SingleTrajectory_cle(V, X, speConstIndecies, numSpecies, numReactions, speValues, tfinal, recordStep, verbose_flag, tau)
...
while t < tfinal
    ...
    % get sampling of random variables and sub into CLE formula
    tauA = tau*A;
    d = tauA + sqrt( abs(tauA) ) .* normrnd(0,1,numReactions,1)';
